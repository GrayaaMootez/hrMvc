...
public class EmpDetailsViewId implements java.io.Serializable {
	...
	public EmpDetailsViewId(int employeeId, String jobId, Long managerId, Long departmentId, Long locationId,
			String countryId, String firstName, String lastName, Long salary, Long commissionPct, String departmentName,
			String jobTitle, String city, String stateProvince, String countryName, String regionName) {
		this.employeeId = employeeId;
		this.jobId = jobId;
